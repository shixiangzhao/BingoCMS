package com.shixzh.bcms.framework.aspect;
...
public class SystemArchitecture {
	 ...
	 * com.shixzh.bcms.controller or any sub-package under that.
	 */
	@Pointcut("within(com.shixzh.bcms.controller..*)")
	public void inWebLayer() {
	}

	/**
	 * A join point is in the data access layer if the method is defined in a type
	 * in the com.shixzh.bcms.dao package or any sub-package under that.
	 */
	@Pointcut("within(com.shixzh.bcms.dao..*)")
	 ...
	 * com.xyz.someapp.abc.service and com.xyz.def.service) then the pointcut
	 * expression "execution(* com.xyz.someapp..service.*.*(..))" could be used
	 * instead.
	 *
	 ...
	 */
	@Pointcut("execution(* com.shixzh.bcms.service..*.*(..))")
	 ...
	 */
	@Pointcut("execution(* com.shixzh.bcms.dao.*.*(..))")
